...
class MyApp extends JFrame {
  ...
  String background_image_path = "src/main/java/Mirea/Homework8/background.jpg";
  String animation_images_path = "src/main/java/Mirea/Homework8/anim";
  int method;
  ...
  void animate(String frames_path, Graphics2D g) {
    ...
    for (File file : dir.listFiles()) {
      ...
      Image frame1 = Toolkit.getDefaultToolkit().getImage(file.getPath());
      g.drawImage(frame, 0, 0, WINDOW_WIDTH, WINDOW_HEIGHT, this);
      try {
        Thread.sleep(500);
      } catch (InterruptedException e) {
      }
      g.drawImage(frame1, 0, 0, WINDOW_WIDTH, WINDOW_HEIGHT, this);
      try {
        Thread.sleep(500);
      } catch (InterruptedException e) {
      }
