...
public class Main {
  public static void main(String[] args) {
    ...
    String directoryPath = "/Java/Mirea/Homework19";
    List<String> fileList = DirectoryLister.listDirectory(directoryPath);
    for (int i = 0; i < 3 && i < fileList.size(); i++) {
      System.out.println(fileList.get(i));
    }

    // Тестирование вспомогательных методов в классе Solution
    ArrayList<String> stringList2 = Solution2.newArrayList("Hello", "bbb");
    System.out.println(stringList2);

    HashSet<Integer> intSet = Solution2.newHashSet(1, 7, 10);
    System.out.println(intSet);

    HashMap<String, Integer> map = Solution2.newHashMap("Key", 4);
